...
<section class="relative h-[664px] xl:h-[768px] w-full overflow-hidden">
    ...
    <div class="absolute top-[35%] px-[20px] pb-[24px] z-10 flex flex-col items-center gap-[14px] text-center w-full">
